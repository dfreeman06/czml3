...
data_files_spec = [
    ('share/jupyter/labextensions/@poliastro/czml3', 'czml3/labextension', '**'),
    ('share/jupyter/labextensions/@poliastro/czml3', '.', 'install.json'),
]
...
setup_args = dict(
    ...
    author          = 'czml3 contributors',
    author_email    = 'czml@noreplay.github.com',
